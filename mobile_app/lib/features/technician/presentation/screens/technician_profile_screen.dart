              ...
              children: [
                Container(
                  ...
                  child: const CircleAvatar(
                    ...
                    child: Icon(Icons.engineering_rounded, size: 44, color: Colors.white),
                  ),
                ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildReadOnlyRow('الدور الموظف', 'فني ميداني مرخص'),
                const Divider(color: Colors.white10),
                _buildReadOnlyRow('المنطقة المسؤولة', user['zone_name'] ?? '—'),
              ],
            ),
